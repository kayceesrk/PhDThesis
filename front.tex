...
compute systems providing \emph{strong memory consistency}, where there is a
...
in favor of weakly consistent memory. As a result there is a growing proportion
of developers who must tackle the full complexity of concurrent programming for
an asynchronous distributed systems.
