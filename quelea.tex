...
\newcommand{\stretcharraybig}{\renewcommand*{\arraystretch}{1}}
...
\hfill
\subfigure[Negative balance]{\label{fig:negativeBalanceAnomaly}\includegraphics[width=0.28\columnwidth]{Figures/Motivation2}}
\hfill
\subfigure[Missing update]{\label{fig:missingUpdateAnomaly}\includegraphics[width=0.24\columnwidth]{Figures/Motivation1}}
...
the causally preceding \cf{deposit}, and reports the balance of negative 50 to
the user.
...
Basic guarantee provided by the store is causal visibility, which is captured by
...
\label{lem:auxred-wf} \hfill
For every execution state $\E$ that is well-formed, if
...
\begin{figure*}[t]
  \centering
  \subfigure[Latency]{\label{grf:BA-lat}\includegraphics[width=0.31\textwidth]{graphs/BA-lat.pdf}}
  \subfigure[Throughput]{\label{grf:BA-tp}\includegraphics[width=0.31\textwidth]{graphs/BA-tp.pdf}}
  \subfigure[Throughput vs. Latency]{\label{grf:BA-tp-vs-lat}\includegraphics[width=0.31\textwidth]{graphs/BA-tp-vs-lat.pdf}}
...
\begin{figure*}[t]
  \centering
  \subfigure[Latency]{\label{grf:LWW-txn-lat}\includegraphics[width=0.31\textwidth]{graphs/LWW-txn-lat.pdf}}
  \subfigure[Throughput]{\label{grf:LWW-txn-tp}\includegraphics[width=0.31\textwidth]{graphs/LWW-txn-tp.pdf}}
  \subfigure[Throughput vs. Latency]{\label{grf:LWW-txn-tp-vs-lat}\includegraphics[width=0.31\textwidth]{graphs/LWW-txn-tp-vs-lat.pdf}}
...
\begin{figure}[t]
  \centering
  \subfigure[Latency]{\label{grf:rubis-lat}\includegraphics[width=0.31\textwidth]{graphs/Rubis-lat.pdf}}
  \subfigure[Throughput]{\label{grf:rubis-tp}\includegraphics[width=0.31\textwidth]{graphs/Rubis-tp.pdf}}
  \subfigure[Throughput vs. Latency]{\label{grf:Rubis-tp-vs-lat}\includegraphics[width=0.31\textwidth]{graphs/Rubis-tp-vs-lat.pdf}}
