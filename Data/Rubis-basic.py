...
def main ():
	files = ["Rubis-lat.dat","Rubis-tp.dat"]
	for f in files:
		Cassandra = []
		EC = []
		CC = []
		...
		plt.plot (ecx, ecy, nodeKind [1], label="NoRep", linewidth=2.0, ms=15)
		plt.plot (ccx, ccy, nodeKind [2], label="StrongRep", linewidth=2.0, ms=15)
