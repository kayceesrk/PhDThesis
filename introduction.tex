...
models such as OpenMP~\cite{OBrien}, COMIC~\cite{Lee2008},
...
programming~\cite{Grossman}. A mostly functional programming language combined
...
Cassandra~\cite{Cassandra}, Riak~\cite{Riak} provide a data model that is
...
deterministically. We will see that this particular abstraction is powerful
enough to describe complex real-world scenarios such as twitter-like
microblogging service and an ebay-like auction site.

-- on top of cassandra.

-- mapping contracts to implementations.
