...
\newcommand{\spawn}[1]{\k{spawnHost}(#1)}
\newcommand{\async}[1]{\k{spawnParasite}(#1)}
\newcommand{\infl}[1]{\k{inflate}(#1)}
\newcommand{\reif}[1]{\k{reify}(#1)}
\newcommand{\unit}{\k{unit}}
\newcommand{\fresh}[1]{#1\; \I{fresh}}
\newcommand{\RULE}[2]{\frac{\begin{array}{c}#1\end{array}}{
                            \begin{array}{c}#2\end{array}}}
\newcommand{\send}[2]{\k{send}(#1,#2)}
\newcommand{\recv}[1]{\k{recv}(#1)}
\newcommand{\mkCh}{\k{chan()}}
\newcommand{\ALT}{~\mid~}
